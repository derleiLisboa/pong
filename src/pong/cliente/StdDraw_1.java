 ...
 *  @author Kevin Wayne
 */
public final class StdDraw_1 implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static StdDraw_1 std = new StdDraw_1();
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = StdDraw_1.class.getResource(filename);
            if (url != null)
                icon = new ImageIcon(url);
        }
    ...
    ***************************************************************************/
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(StdDraw_1.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
        chooser.setVisible(true);
        String filename = chooser.getFile();
        if (filename != null) {
            StdDraw_1.save(chooser.getDirectory() + File.separator + chooser.getFile());
        }
    }
    ...
    ***************************************************************************/
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = StdDraw_1.userX(e.getX());
            mouseY = StdDraw_1.userY(e.getY());
            mousePressed = true;
        }
    }
    ...
    *  as an argument. It can handle action keys
     ...
     */
    public static void main(String[] args) {
        StdDraw_1.square(.2, .8, .1);
        StdDraw_1.filledSquare(.8, .8, .2);
        StdDraw_1.circle(.8, .2, .2);

        StdDraw_1.setPenColor(StdDraw_1.BOOK_RED);
        StdDraw_1.setPenRadius(.02);
        StdDraw_1.arc(.8, .2, .1, 200, 45);

        // draw a blue diamond
        StdDraw_1.setPenRadius();
        StdDraw_1.setPenColor(StdDraw_1.BOOK_BLUE);
        double[] x = { .1, .2, .3, .2 };
        double[] y = { .2, .3, .2, .1 };
        StdDraw_1.filledPolygon(x, y);

        // text
        StdDraw_1.setPenColor(StdDraw_1.BLACK);
        StdDraw_1.text(0.2, 0.5, "black text");
        StdDraw_1.setPenColor(StdDraw_1.WHITE);
        StdDraw_1.text(0.8, 0.8, "white text");
    }
